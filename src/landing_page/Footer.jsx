...
const Footer = () => {
  return (
    <>
      <div>
        <footer className='m-9 p-9 border-2 bg-blue h-auto w-auto bg-neutral-500 rounded-2xl'>
          <div >
          ...
          <p className="flex justify-center align-middle text-2xl font-light cursor-pointer hover:text-amber-200"> 100% made by Human</p>
